...
export function FormRegisterSiswa() {
    const [formData, setFormData] = useState<RegisterSiswa>({
        email: '',
        password: '',
        confirmPassword: '',
        nisn: '',
    ...
    const [errors, setErrors] = useState<Partial<Record<keyof RegisterSiswa, string>>>({});

    const handleChange = (field: keyof RegisterSiswa, value: string) => {
    ...
    const validateForm = (): boolean => {
        const newErrors: Partial<Record<keyof RegisterSiswa, string>> = {};
    ...
    return (
        <Card className="max-w-2xl mx-auto">
            <CardHeader>
                <CardTitle className="text-2xl">Form Registrasi Siswa</CardTitle>
                <CardDescription>
